...
type HelpDeskHeroProps = {
    title?: string;
    subtitle?: ReactNode;
};

const HelpDeskHero: FC<HelpDeskHeroProps> = ({
    title = 'How can we help?',
    subtitle = 'Explore our knowledge badge to learn more about all the functionality Prompt is offering. If you do not find what you are looking, feel free to contact our support team.',
}) => {
    return (
            ...
            <Container>
                <Row className="justify-content-center">
                    <Col lg={7} className="text-center">
                        ...
                        <p className="fs-17 text-muted">{subtitle}</p>
